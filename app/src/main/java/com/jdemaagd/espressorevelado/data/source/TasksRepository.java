package com.jdemaagd.espressorevelado.data.source;
...
public class TasksRepository implements TasksDataSource {
    ...
    /**
     * Marks cache as invalid, to force an update next time data is requested
     * This variable has package local visibility so it can be accessed from tests
     */
     ...
     * to create a new instance next time it is called
     */
     ...
     * is fired if all data sources fail to get data
     */
    @Override
