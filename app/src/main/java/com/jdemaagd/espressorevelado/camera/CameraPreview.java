package com.jdemaagd.espressorevelado.camera;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        // install SurfaceHolder.Callback so we get notified when
    ...
    /**
     * Calculate correct orientation for a {@link Camera} preview that is displayed on screen
     * <p>
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        // Surface has been created now tell camera where to draw preview
        try {
