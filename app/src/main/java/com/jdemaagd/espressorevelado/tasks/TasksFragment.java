...
import com.jdemaagd.espressorevelado.taskdetail.TaskDetailActivity;
...
public class TasksFragment extends Fragment implements TasksContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // set scrolling view in custom SwipeRefreshLayout
    ...
    /**
     * Listener for clicks on tasks in ListView
     */
    ...
    private void showNoTasksViews(String mainText, int iconRes, boolean showAddView) {
        ...
        mNoTaskIcon.setImageDrawable(getResources().getDrawable(iconRes, null));
    ...
    public void showTaskDetailsUi(String taskId) {
        ...
        // gives flexibility to show some Intent stubbing
    ...
    public static class TasksAdapter extends RecyclerView.Adapter<TasksAdapter.ViewHolder> {
        ...
        public static class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View itemView) {
                ...
                titleTV = itemView.findViewById(R.id.todo_title);
                completeCB = itemView.findViewById(R.id.todo_complete);
                itemHolder = itemView;
            }
            ...
            public void bind(final Task task) {
                // use views here
                // set data inside views title and checked
                taskHolder = task;
                titleTV.setText(task.getTitleForList());
                completeCB.setChecked(task.isCompleted());

                if (task.isCompleted()) {
                    itemHolder.setBackground(itemHolder.getContext()
                ...
                itemHolder.setOnClickListener(view -> mItemListener.onTaskClick(task));
            }
        }
    }
}